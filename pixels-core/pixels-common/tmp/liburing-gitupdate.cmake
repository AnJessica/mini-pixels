...
execute_process(
  COMMAND "/usr/bin/git" show-ref "liburing-2.2"
  WORKING_DIRECTORY "/home/nika/mini-pixels/pixels-core/pixels-common/liburing"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "liburing-2.2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("liburing-2.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/liburing-2.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nika/mini-pixels/pixels-core/pixels-common/liburing'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nika/mini-pixels/pixels-core/pixels-common/liburing'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
